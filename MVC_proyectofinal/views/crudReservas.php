...
$("#myModal").modal();
    ...
    $resu=$this->crud->modifReservas($id);
    ...
    foreach($resu as $nombre_columna){
        for($i=0;$i<count($nombre_columna)/2;$i++){
           ...
           elseif($i==1){
            ...
            $aulasDisponibles=$this->crud->aulasDisponiblesReservas();
            ...
            elseif($i==3){
               ...
               elseif($i==4){
                ...
                <label for="">Grupo </label>';
                    ...
                    $gruposDisponibles=$this->crud->gruposDisponiblesReservas();
...
<input type="submit" name="borrar" value="Borrar en lote" class="btn btn-danger" style="float:right; margin-bottom:1%">
        ...
        foreach($result[0] as $indice=>$dato){
            ...
            <a class="btn btn-danger"  href="?c=borrarReservas&id=<?php echo $dato["id"] ?>&pag=<?php echo $_GET["page"]?>"><i class="bi bi-trash"></i></a>
...
for($i=1;$i<=$total_pages;$i++){
    if($i==$page){
        ...
        echo "<li class='page-item'><a class='page-link' href='?c=crudReservas&page=$i'>$i</a></li>";
