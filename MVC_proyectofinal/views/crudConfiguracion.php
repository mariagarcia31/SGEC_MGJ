...
if($count[0]==0){
    ...
    echo "<a href='?c=crudConfiguracion&page=".$_GET['page']."&crear=1'><button name='crear'  class='btn btn-success'> Agregar</button></a>
    ...
    if(isset($_GET["crear"])){
        ...
        align-content: center;'><form action='?c=crearConfiguracion&pag=".$_GET['page']."' method='post' > <table class='table table-striped bg-white ' style='margin-top:2%'>";
...
<div class="row" style="margin-top:5%">
                ...
                <div class="col-md-12 ">
                <h1 style="color:black; text-align:center; margin-bottom:0%; background-color:white" >Configuración</h1>
        ...
        '<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                echo "<form action='?c=crearConfiguracion&pag=".$_GET['page']."' method='post'>";
                ...
                echo '<div class="form-group">
                    ...
                    echo "<input class='btn btn-primary' type='submit'  name='agregar-ult' value='Crear'></input> ";
                    echo '<a href="?c=crudConfiguracion&page='.$_GET['page'].'"><button type="button" class="btn btn-danger">Cancelar</button></a>';
                    echo '</div>';
                    echo "</form>";
                    echo '</div>';
                    echo '</div>';
                    ...
                    if(isset($_SESSION["modificar"])){
                        ...
                        '<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            ...
                            echo "<form action='?c=modificarConfiguracion&pag=".$_GET['page']."' method='post'>";
                            if(isset($_SESSION['vacio'])){
                                echo $_SESSION['vacio'];
                                unset($_SESSION['vacio']);
                            }
...
<?php
       ...
       echo "<tr ><th>Eliminar</th>";
        ...
        echo "</tr>";
        ?>
<form action="?c=borrarConfiguracion&pag=<?php echo $_GET["page"]?>" method="post"> 
...
<?php
        ...
        foreach($result[0] as $indice=>$dato){
            ...
            <td>            
            <a class="btn btn-danger"  href="?c=borrarConfiguracion&id=<?php echo $dato["id"] ?>&pag=<?php echo $_GET["page"]?>"><i class="bi bi-trash"></i></a>
...
<div style="margin-bottom: 100px;
    ...
    <nav aria-label="...">
		...
		<li style="<?php echo $_GET['page']==1 ? 'display:none' : '' ?>" class="page-item">
				<a class="page-link" href="inicio.php?c=crudConfiguracion&page=<?php echo $_GET['page']-1?>"><</a>
			</li>
            <li class="page-item active" >
				...
				<?php for($i=0;$i<=$total_pages;$i++): 
                    ...
                    background-color: #212529!important;" href="inicio.php?c=crudConfiguracion&page=<?php echo $_GET['page']?>"><?php echo $i ?></a>
                    </li>
                    
                    <li class="page-item" style="<?php echo $i==$total_pages ? 'display:none' : '' ?>">
                    <a class="page-link" href="inicio.php?c=crudConfiguracion&page=<?php echo $_GET['page']+1?>"><?php echo $i+1 ?></a>
