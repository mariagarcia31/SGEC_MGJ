...
if ((isset($_COOKIE['contrasena']) || isset($_SESSION['contra']) && isset($_SESSION["cambiado"])) && isset($_SESSION["crudConfiguracion"]) ){
...
if($count[0]==0){
    ...
    echo "<a href='?c=crudConfiguracion&page=".$_GET['page']."&crear=1'><button name='crear' style='font-size:14px' class='btn btn-success'> Agregar</button></a>
