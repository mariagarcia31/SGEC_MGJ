...
if ((isset($_COOKIE['contrasena']) || isset($_SESSION['contra']) && isset($_SESSION["cambiado"])&& isset($_SESSION["crudGrupos"])) ){
...
if($count[0]==0){
    ...
    echo "<a href='?c=crudGrupos&page=".$_GET['page']."&crear=1'><button name='crear' style='font-size:14px; margin-bottom:30px'  class='btn btn-success'> Agregar</button></a>
...
<?php include "barraBusquedaGrupos/barra.php"; ?>
                <div class="col-md-12 ">
                <h1 style="color:black; text-align:center; margin-bottom:0%; background-color:white; margin-top:50px" >Grupos</h1>
        ...
        '<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                echo "<form style='font-size:14px' action='?c=crearGrupos&pag=".$_GET['page']."' method='post'>";
               ...
               /* echo '<div class="form-group">
                    ...
                    echo "<input class='btn btn-primary' type='submit' style='font-size:14px' name='agregar-ult' value='Crear'></input> ";
                    echo '<a href="?c=crudGrupos&page='.$_GET['page'].'"><button style="font-size:14px" type="button" class="btn btn-danger">Cancelar</button></a>';
                    echo '</div>';
                    echo "</form>";
                    echo '</div>';
                    echo '</div>';
                    ...
                    if(isset($_SESSION["modificar"])){
                        ...
                        '<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            ...
                            echo "<form style='font-size:14px' action='?c=modificarGrupos&pag=".$_GET['page']."' method='post'>";
                            if(isset($_SESSION['vacio'])){
                                echo $_SESSION['vacio'];
                                unset($_SESSION['vacio']);
                            }
...
<?php
       ...
       echo "<tr ><th>Eliminar</th>";
        ...
        echo "</tr>";
        ?>
<form style='font-size:14px' action="?c=borrarGrupos&pag=<?php echo $_GET["page"]?>" method="post"> 
                        ...
                        Swal.fire({
                            ...
                            cancelButtonText: 'Cancelar'
                                ...
                                if (result.isConfirmed) {
                                    window.location.href = "?c=borrarGrupos&id="+id+"&pag="+page;
