            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Sr. Jefe de estudios</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="login.php?cerrar=true" data-toggle="modal" data-target="#logoutModal">
             ...
             <?php //function cerrar(){?>
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="login.php?cerrar=true">Cerrar sesión</a>
                </div>
                </div>
                </div>
                </div>
