...
<div class="barra" style='border: 1px solid  #212529;border-radius:3.2rem; display:inline !important;padding:1.1rem !important'>

<i class="bi bi-search" style="font-size: 20px;padding-right: 10px;margin-left:3%;"></i>
<input type="text" id="search" placeholder="Buscar por nombre..."  style="width: 30%; font-size:1.5rem; border:none; background: transparent !important;"/>
