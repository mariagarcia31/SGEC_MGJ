...
if ((isset($_COOKIE['contrasena']) || isset($_SESSION['contra']) && isset($_SESSION["cambiado"]) && isset($_SESSION["crudDepartamentos"]))){
...
$count=$this->crud->crudDepartamentos(1);
...
if($count[0]==0){
    ...
    <div class="row >
    <div class="col-md-12 ">
    <h1 class="display-3"> No se han creado departamentos aún</h1>';
 
    echo "<a href='?c=crudDepartamentos&page=".$_GET['page']."&crear=1'><button name='crear' style='font-size:14px;margin-bottom:30px' class='btn btn-success'> Agregar</button></a>
    ...
    if(isset($_GET["crear"])){
        ...
        align-content: center;'><form style='font-size:14px' action='?c=crearDepartamentos&pag=".$_GET['page']."' method='post' > <table class='table table-striped bg-white ' style='margin-top:2%'>";
...
$result=$this->crud->crudDepartamentos(2,$iteams_pagina,$offset);
...
<?php include "barraBusquedaDepartamentos/barra.php"; ?>
                <div class="col-md-12 ">
                <h1 style="color:black; text-align:center; margin-bottom:0%; background-color:white; margin-top:50px" >Departamentos</h1>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h3 class="modal-title" id="exampleModalLongTitle">Crear departamento</h3>
                </div>
                <div class="modal-body">';
        
                echo "<form style='font-size:14px' action='?c=crearDepartamentos&pag=".$_GET['page']."' method='post'>";
                    ...
                    echo "<input class='btn btn-primary' type='submit' style='font-size:14px' name='agregar-ult' value='Crear'></input> ";
                    echo '<a href="?c=crudDepartamentos&page='.$_GET['page'].'"><button type="button"  style="font-size:14px" class="btn btn-danger">Cancelar</button></a>';
                    echo '</div>';
                    echo "</form>";
                    echo '</div>';
                    echo '</div>';
                    ...
                    if(isset($_SESSION["modificar"])){
                            ...
                            $resu=$this->crud->modifDepartamentos($id);
                        ...
                        '<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                            ...
                            echo "<form style='font-size:14px' action='?c=modificarDepartamentos&pag=".$_GET['page']."' method='post'>";
                            if(isset($_SESSION['vacio'])){
                                echo $_SESSION['vacio'];
                                unset($_SESSION['vacio']);
                            }
...
<?php
       ...
       echo "<tr ><th>Eliminar</th>";
        ...
        echo "</tr>";
        ?>
<form style='font-size:14px' action="?c=borrarDepartamentos&pag=<?php echo $_GET["page"]?>" method="post"> 
...
<?php
        ...
        foreach($result[0] as $indice=>$dato){
            echo "<td><input type='checkbox' name='eliminar[]' value=' ".$dato['departamento']."'</td>";
...
<div style="margin-bottom: 100px;
    ...
    <nav aria-label="...">
		...
		<li style="<?php echo $_GET['page']==1 ? 'display:none' : '' ?>" class="page-item">
				<a class="page-link" href="inicio.php?c=crudDepartamentos&page=<?php echo $_GET['page']-1?>"><</a>
			</li>
            <li class="page-item active" >
				...
				<?php for($i=0;$i<=$total_pages;$i++): 
                    ...
                    background-color: #212529!important;" href="inicio.php?c=crudDepartamentos&page=<?php echo $_GET['page']?>"><?php echo $i ?></a>
                    </li>
                    
                    <li class="page-item" style="<?php echo $i==$total_pages ? 'display:none' : '' ?>">
                    <a class="page-link" href="inicio.php?c=crudDepartamentos&page=<?php echo $_GET['page']+1?>"><?php echo $i+1 ?></a>
